...
var getProperties = __webpack_require__(33);
var isProxyEnabled = __webpack_require__(10);
...
var cloneDeep = _interopDefault(__webpack_require__(154));
var vueTemplateCompiler = __webpack_require__(160);
...
module.exports = {"_args":[["vue-template-compiler@2.4.2","/Users/castro.campioni/repos/vue-hotel-datepicker"]],"_development":true,"_from":"vue-template-compiler@2.4.2","_id":"vue-template-compiler@2.4.2","_inBundle":false,"_integrity":"sha512-sKa2Bdvh+j6V9eQSyJRxsf8fak0FtQkCZ145aYFDVwZBhHOTt1vKrODLo4RelI1dUczKlDCp5aZ9MD7uJOZwvw==","_location":"/vue-template-compiler","_phantomChildren":{},"_requested":{"type":"version","registry":true,"raw":"vue-template-compiler@2.4.2","name":"vue-template-compiler","escapedName":"vue-template-compiler","rawSpec":"2.4.2","saveSpec":null,"fetchSpec":"2.4.2"},"_requiredBy":["#DEV:/"],"_resolved":"https://registry.npmjs.org/vue-template-compiler/-/vue-template-compiler-2.4.2.tgz","_spec":"2.4.2","_where":"/Users/castro.campioni/repos/vue-hotel-datepicker","author":{"name":"Evan You"},"bugs":{"url":"https://github.com/vuejs/vue/issues"},"dependencies":{"de-indent":"^1.0.2","he":"^1.1.0"},"description":"template compiler for Vue 2.0","homepage":"https://github.com/vuejs/vue/tree/dev/packages/vue-template-compiler#readme","keywords":["vue","compiler"],"license":"MIT","main":"index.js","name":"vue-template-compiler","repository":{"type":"git","url":"git+https://github.com/vuejs/vue.git"},"version":"2.4.2"}
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(54), __webpack_require__(7)))
...
var map = {
	"./datepicker.spec.js": 161,
	"./datepickerDay.spec.js": 162,
	"./datepickerHelpers.spec.js": 163
};
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var testsContext = __webpack_require__(57);
...
var flag = __webpack_require__(0);
var proxify = __webpack_require__(11);
...
var pathval = __webpack_require__(158);
...
exports.compareByInspect = __webpack_require__(67);
...
exports.getOwnEnumerableProperties = __webpack_require__(71);

/*!
 * Checks error against a given set of criteria
 */

exports.checkError = __webpack_require__(78);

/*!
 * Proxify util
 */

exports.proxify = __webpack_require__(11);
...
exports.isProxyEnabled = __webpack_require__(10);

/*!
 * isNaN method
 */

exports.isNaN = __webpack_require__(73);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(18)(module), __webpack_require__(7)))
...
var deindent = _interopDefault(__webpack_require__(79));
var he = _interopDefault(__webpack_require__(81));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(54), __webpack_require__(7)))
...
try {
  var vueVersion = __webpack_require__(56).version
} catch (e) {}

var packageName = __webpack_require__(55).name
var packageVersion = __webpack_require__(55).version
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_test_utils__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chai__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chai___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_chai__);
throw new Error("Cannot find module \"@/components/WIP\"");
...
describe('Datepicker Calendar', () => {
  let wrapper = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_vue_test_utils__["shallow"])(__WEBPACK_IMPORTED_MODULE_2__components_WIP___default.a);

  it('should correctly re-render the calendar', () => {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(wrapper.vm.show).to.equal(true);
    wrapper.vm.reRender();
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(wrapper.vm.isOpen).to.equal(false);

    setTimeout(() => {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(wrapper.vm.isOpen).to.equal(true);
    }, 200);
  });
});
...
describe('Datepicker Component', () => {
  ...
  before( () => {
    wrapper = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_vue_test_utils__["shallow"])(__WEBPACK_IMPORTED_MODULE_2__components_WIP___default.a, {
  ...
  it('should toggle the calendar visibility on input click', () => {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(
      wrapper.vm.isOpen
    ).to.equal(false);
  ...
  it('should correctly parse and sort the disabled dates', () => {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(wrapper.vm.sortedDisabledDates).to.eql([
      new Date ('2018-01-02'),
      new Date ('2018-01-05'),
      new Date ('2018-01-06'),
      new Date ('2018-01-15'),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chai__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chai___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_chai__);
throw new Error("Cannot find module \"@/components/Day\"");
...
describe('Datepicker Day', () => {
  ...
  before( () => {
    wrapper = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_vue_test_utils__["shallow"])(__WEBPACK_IMPORTED_MODULE_2__components_Day___default.a, {
      propsData: {
        allowedCheckoutDays: [],
        activeMonthIndex: 0,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chai__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chai___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_chai__);
throw new Error("Cannot find module \"@/components/helpers\"");
...
describe('Datepicker Helpers', () => {
  ...
  describe('countDays', () => {
    it('should correctly count the number of days between two given dates', () => {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(
        __WEBPACK_IMPORTED_MODULE_2__components_helpers___default.a.countDays('10-10-2017', '10-15-2017')
      ).to.equal(5);
    });
  });
  ...
  describe('addDays', () => {
    it('should return the correct date when given a date and the amount of days to add', () => {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(
        __WEBPACK_IMPORTED_MODULE_2__components_helpers___default.a.addDays('10-10-2017', 5)
  ...
  describe('getFirstSunday', () => {
    it('should return the first sunday of a given month', () => {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(
        __WEBPACK_IMPORTED_MODULE_2__components_helpers___default.a.getFirstSunday(new Date('10-10-2017'))
  ...
  describe('getFirstDayOfMonth', () => {
    it('should return the first sunday of a given month', () => {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(
        __WEBPACK_IMPORTED_MODULE_2__components_helpers___default.a.getFirstDayOfMonth(new Date('12-10-2017'))
  ...
  describe('getNextMonth', () => {
    it('should return the next month of a given date', () => {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(
        __WEBPACK_IMPORTED_MODULE_2__components_helpers___default.a.getNextMonth(new Date('12-10-2017'))
  ...
  describe('isDateLessOrEquals', () => {
    it('should return a boolean when comparing two dates', () => {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(
        __WEBPACK_IMPORTED_MODULE_2__components_helpers___default.a.isDateLessOrEquals(new Date('12-10-2017'), new Date('10-10-2017'))
      ).to.equal(false);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_chai__["expect"])(
        __WEBPACK_IMPORTED_MODULE_2__components_helpers___default.a.isDateLessOrEquals(new Date('12-10-2017'), new Date('12-15-2017'))
      ).to.equal(true);
    });
  });
