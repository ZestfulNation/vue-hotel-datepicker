...
/* harmony default export */ var helpers = ({
  ...
  swipeAfterScroll: function swipeAfterScroll(direction) {
    if (this.screenSize !== "desktop" && this.$refs && this.$refs.swiperWrapper && this.isOpen) {
      var swiperWrapper = this.$refs.swiperWrapper; // If wrapper has vertical scroll
...
/* harmony default export */ var Dayvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    checkinCheckoutClass: function checkinCheckoutClass() {
      ...
      if (currentDate) {
        if (currentDate.periodType === "nightly" && this.belongsToThisMonth && !this.isDisabled) {
          return "nightly";
        } // date.getDay() === 6 => saturday


        if (currentDate.periodType === "weekly_by_saturday" && currentDate.startAt !== this.formatDate && currentDate.endAt !== this.formatDate && this.date.getDay() !== 6) {
          return "datepicker__month-day--disabled datepicker__month-day--not-allowed weekly_by_saturday";
        } // date.getDay() === 0 => sunday


        if (currentDate.periodType === "weekly_by_sunday" && currentDate.startAt !== this.formatDate && currentDate.endAt !== this.formatDate && this.date.getDay() !== 0) {
...
var component = normalizeComponent(
  ...
  Dayvue_type_template_id_730d6898_render,
  Dayvue_type_template_id_730d6898_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"6d1d4e83-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DateInput.vue?vue&type=template&id=7e6c1676&
var DateInputvue_type_template_id_7e6c1676_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"datepicker__input",class:_vm.inputClass,attrs:{"data-qa":"datepickerInput","tabindex":_vm.tabIndex},on:{"click":_vm.toggleDatepicker,"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }$event.stopPropagation();$event.preventDefault();return _vm.toggleDatepicker($event)}}},[_vm._v(" "+_vm._s(_vm.inputDate ? _vm.inputDate : _vm.i18n[_vm.inputDateType])+" ")])}
var DateInputvue_type_template_id_7e6c1676_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/DateInput.vue?vue&type=template&id=7e6c1676&
...
var DateInput_component = normalizeComponent(
  ...
  DateInputvue_type_template_id_7e6c1676_render,
  DateInputvue_type_template_id_7e6c1676_staticRenderFns,
  false,
  null,
  null,
  null
