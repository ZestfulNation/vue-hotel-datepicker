...
describe('Datepicker Calendar', () => {
  const wrapper = mount(Datepicker, { propsData: { value: true } })
...
describe('Datepicker Props', () => {
  ...
  describe('alwaysVisible', () => {
    it('renders the calendar content without needing it to be opened', async () => {
      const wrapper = mount(Datepicker, { propsData: { value: true, alwaysVisible: true } })
  ...
  describe('closeDatepickerOnClickOutside', () => {
    it('hides the datepicker via clickOutside() when true (default)', () => {
      const wrapper = mount(Datepicker, { propsData: { closeDatepickerOnClickOutside: true } })
    ...
    it('keeps the datepicker open via clickOutside() when false', () => {
      const wrapper = mount(Datepicker, { propsData: { closeDatepickerOnClickOutside: false } })
  ...
  describe('disabledDaysOfWeek (deprecated)', () => {
    it('disables the given days of the week', () => {
      const wrapper = mount(Datepicker, { propsData: { disabledDaysOfWeek: ['Monday', 'Tuesday'] } })
  ...
  describe('displayClearButton', () => {
    it('shows the clear button once a date is selected when true (default)', async () => {
      const wrapper = mount(Datepicker, { propsData: { startDate: '2020-01-01' } })
    ...
    it('never shows the clear button when false', async () => {
      const wrapper = mount(Datepicker, { propsData: { startDate: '2020-01-01', displayClearButton: false } })
  ...
  describe('endingDateValue / startingDateValue', () => {
    it('initializes checkIn and checkOut from the props', () => {
      ...
      const wrapper = mount(Datepicker, { propsData: { startingDateValue, endingDateValue } })
  ...
  describe('gridStyle', () => {
    it('toggles the grid style class', () => {
      const wrapperTrue = mount(Datepicker, { propsData: { value: true, gridStyle: true } })
      const wrapperFalse = mount(Datepicker, { propsData: { value: true, gridStyle: false } })
  ...
  describe('hoveringTooltip', () => {
    it('passes the value through to the day options', () => {
      const wrapper = mount(Datepicker, { propsData: { hoveringTooltip: false } })
  ...
  describe('i18n', () => {
    it('renders the custom check-in/check-out placeholders', () => {
      ...
      const wrapper = mount(Datepicker, { propsData: { value: true, i18n: customI18n } })
  ...
  describe('maxNights', () => {
    it('disables dates beyond maxNights after check-in', () => {
      const wrapper = mount(Datepicker, { propsData: { startDate: '2020-01-01', maxNights: 3 } })
  ...
  describe('minNights', () => {
    it('is used as the minimum night count by default', () => {
      const wrapper = mount(Datepicker, { propsData: { minNights: 5 } })
  ...
  describe('positionRight', () => {
    it('positions the calendar on the right', () => {
      const wrapper = mount(Datepicker, { propsData: { value: true, positionRight: true } })
  ...
  describe('showSingleMonth', () => {
    ...
    it('renders two months by default', async () => {
      const wrapper = mount(Datepicker, { propsData: { value: true, startDate: '2020-01-01', alwaysVisible: true } })
  ...
  describe('singleDaySelection', () => {
    it('only renders a single check-in input', () => {
      const wrapper = mount(Datepicker, { propsData: { value: true, singleDaySelection: true } })
    ...
    it('sets checkOut equal to checkIn when a day is clicked', () => {
      const wrapper = mount(Datepicker, { propsData: { startDate: '2020-01-01', singleDaySelection: true } })
  ...
  describe('tooltipMessage', () => {
    it('overrides the default hovering tooltip text', () => {
      const wrapper = mount(Datepicker, { propsData: { tooltipMessage: 'Custom Tooltip' } })
  ...
  describe('value', () => {
    it('does not render the wrapper when false', () => {
      const wrapper = mount(Datepicker, { propsData: { value: false } })

      expect(wrapper.find('.vhd__datepicker__wrapper').exists()).to.equal(false)
      wrapper.destroy()
    })

    it('emits input when the open state changes', () => {
      const wrapper = mount(Datepicker, { propsData: { value: true } })
...
describe('Datepicker Events', () => {
  ...
  it('emits next-month-rendered when paginating past the pre-generated months', () => {
    ...
    const wrapper = mount(Datepicker, { propsData: { startDate: '2020-01-01', value: true } })

    jest.useFakeTimers()
    jest.advanceTimersByTime(Date.now() + 60 * 60 * 1000)
    wrapper.vm.renderNextMonth()
